	        ...
	        return new es6_promise_1.Promise(function (resolve, reject) {
	            try {
	                ...
	                list.forEach(function (file) {
	                    if (file !== '.' && file != '..') {
	                        results_2.push(_this.unescape(file));
	                    }
	                });
	                resolve(results_2);
	            }
	                ...
	                results.forEach(function (url) {
	                    client.get(_this.getKey(url), function (err, data) {
	                        ...
	                        if (data !== null) {
	                            ...
	                            client.hdel(_this.domainHashKey, url);
	                        }
	        ...
	        return new es6_promise_1.Promise(function (resolve, reject) {
	            ...
	            client.hset(_this.hashKey, _this.domain, _this.domain, function (err, result) {
	                if (err) {
	                    ...
	                    debug('REDIS SET 1');
	                    client.hset(_this.domainHashKey, key, value, function (err, value) {
	                        if (err) {
	                            reject(err);
	                            return;
	                        }
